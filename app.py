...
def create_llms_model():
    llm = CTransformers(model="TheBloke/Mistral-7B-Instruct-v0.2-GGUF", config={'max_new_tokens': 512, 'temperature': 0.01})
    return llm
...
with container:
    with st.form(key='my_form', clear_on_submit=True):
        user_input = st.text_input("Question:", placeholder="Ask right away", key='input')
